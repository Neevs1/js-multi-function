...
function input(){
    document.getElementById("result").innerHTML ="Inputted value is"+ document.getElementById("inp").value;
}
function mod(){
    let num1 = parseInt(prompt("Enter the second number: "));
    let num2 = parseInt(prompt("Enter the second number: "));
    num3 = num1 % num2;
    document.getElementById("result").innerHTML = "The modulus of the two numbers is: " + num3;
